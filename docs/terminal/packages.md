...
| [`gh`](https://formulae.brew.sh/formula/gh)                           | [cli/cli](https://github.com/cli/cli)                               | GitHub CLI used by [`git-github-auth`](../scripts/security-keys.md#git-github-auth) and [`ssh-sk get --github`](../scripts/security-keys.md#ssh-sk-get-github).                            |
